          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <input type="text" inputMode="numeric" pattern="[0-9]*" value={nopKec} onChange={e => setNopKec(e.target.value)} maxLength={3} className={`w-14 px-2 py-2 border border-[var(--border)] rounded text-center text-sm ${isNopLocked ? "bg-[var(--section-bg)]" : "bg-[var(--input-bg)] text-[var(--text-primary)]"} focus:ring-2 focus:ring-purple-500 outline-none`} readOnly={isNopLocked} />
                <input type="text" inputMode="numeric" pattern="[0-9]*" value={nopKel} onChange={e => setNopKel(e.target.value)} maxLength={3} className={`w-14 px-2 py-2 border border-[var(--border)] rounded text-center text-sm ${isNopLocked ? "bg-[var(--section-bg)]" : "bg-[var(--input-bg)] text-[var(--text-primary)]"} focus:ring-2 focus:ring-purple-500 outline-none`} readOnly={isNopLocked} />
                <input type="text" inputMode="numeric" pattern="[0-9]*" value={nopBlok} onChange={e => setNopBlok(e.target.value)} maxLength={3} required placeholder="000" className="w-14 px-2 py-2 border border-[var(--border)] rounded text-center text-sm bg-[var(--input-bg)] text-[var(--text-primary)] focus:ring-2 focus:ring-purple-500 outline-none" />
                <input type="text" inputMode="numeric" pattern="[0-9]*" value={nopUrut} onChange={e => setNopUrut(e.target.value)} maxLength={4} required placeholder="0000" className="w-16 px-2 py-2 border border-[var(--border)] rounded text-center text-sm bg-[var(--input-bg)] text-[var(--text-primary)] focus:ring-2 focus:ring-purple-500 outline-none" />
                <input type="text" inputMode="numeric" pattern="[0-9]*" value={nopJenis} onChange={e => setNopJenis(e.target.value)} maxLength={1} required placeholder="0" className="w-10 px-2 py-2 border border-[var(--border)] rounded text-center text-sm bg-[var(--input-bg)] text-[var(--text-primary)] focus:ring-2 focus:ring-purple-500 outline-none" />
              </div>
            </div>
