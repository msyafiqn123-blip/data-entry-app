                ...
                <tr key={item.id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="p-4">
                    {item.isVerified ? (
                      ...
                      <span className="inline-flex items-center px-2 py-1 rounded-full text-[10px] font-medium bg-amber-100 text-amber-700">
                        Menunggu
                      </span>
                    )}
                  </td>
                  <td className="p-4 text-right space-x-2">
                    {item.isVerified ? (
                      <a href={`/dashboard/my-lspop/${item.id}?view=true`} className="inline-flex items-center justify-center px-3 py-1 bg-blue-100 text-blue-700 text-xs font-medium rounded hover:bg-blue-200 transition-colors">
                        Lihat
                      </a>
                    ) : (
                      <>
                        <a href={`/dashboard/my-lspop/${item.id}`} className="inline-flex items-center justify-center px-3 py-1 bg-amber-100 text-amber-700 text-xs font-medium rounded hover:bg-amber-200 transition-colors">
                          Edit
                        </a>
