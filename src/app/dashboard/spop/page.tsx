            ...
            {jenisTransaksi === "Perekaman Data Baru" && (
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-center">
                ...
                <div className="md:col-span-3 flex flex-wrap items-center gap-2">
                  ...
                  <input type="text" value={nopTetKel} onChange={e => setNopTetKel(e.target.value)} maxLength={3} className={`w-14 px-2 py-2 border border-[var(--border)] rounded text-center focus:ring-2 focus:ring-purple-500 outline-none ${isNopLocked ? "bg-[var(--section-bg)] text-[var(--text-secondary)]" : "bg-[var(--input-bg)] text-[var(--text-primary)]"}`} readOnly={isNopLocked} placeholder="Kel" />
                  <input type="text" value={nopTetBlok} onChange={e => setNopTetBlok(e.target.value)} maxLength={3} className="w-16 px-2 py-2 border border-[var(--border)] rounded text-center focus:ring-2 focus:ring-purple-500 outline-none bg-[var(--input-bg)] text-[var(--text-primary)]" placeholder="Blok" />
                  <input type="text" value={nopTetUrut} onChange={e => setNopTetUrut(e.target.value)} maxLength={4} className="w-20 px-2 py-2 border border-[var(--border)] rounded text-center focus:ring-2 focus:ring-purple-500 outline-none bg-[var(--input-bg)] text-[var(--text-primary)]" placeholder="Urut" />
                  <input type="text" value={nopTetJenis} onChange={e => setNopTetJenis(e.target.value)} maxLength={1} className="w-12 px-2 py-2 border border-[var(--border)] rounded text-center focus:ring-2 focus:ring-purple-500 outline-none bg-[var(--input-bg)] text-[var(--text-primary)]" placeholder="Jns" />
                </div>
              </div>
            )}
                ...
                {isPecah === "Ya" && (
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-center">
                    ...
                    <div className="md:col-span-3 flex flex-wrap items-center gap-2">
                      ...
                      <input type="text" value={nopAsalKec} onChange={e => { setNopAsalKec(e.target.value); setNopKec(e.target.value); }} maxLength={3} className={`w-14 px-2 py-2 border border-[var(--border)] rounded text-center focus:ring-2 focus:ring-purple-500 outline-none ${isNopLocked ? "bg-[var(--section-bg)] text-[var(--text-secondary)]" : "bg-[var(--input-bg)] text-[var(--text-primary)]"}`} readOnly={isNopLocked} placeholder="Kec" />
                      <input type="text" value={nopAsalKel} onChange={e => { setNopAsalKel(e.target.value); setNopKel(e.target.value); }} maxLength={3} className={`w-14 px-2 py-2 border border-[var(--border)] rounded text-center focus:ring-2 focus:ring-purple-500 outline-none ${isNopLocked ? "bg-[var(--section-bg)] text-[var(--text-secondary)]" : "bg-[var(--input-bg)] text-[var(--text-primary)]"}`} readOnly={isNopLocked} placeholder="Kel" />
                      <input type="text" required value={nopAsalBlok} onChange={e => { setNopAsalBlok(e.target.value); setNopBlok(e.target.value); }} maxLength={3} className="w-16 px-2 py-2 border border-[var(--border)] rounded text-center focus:ring-2 focus:ring-purple-500 outline-none bg-[var(--input-bg)] text-[var(--text-primary)]" placeholder="Blok" />
                      <input type="text" required value={nopAsalUrut} onChange={e => setNopAsalUrut(e.target.value)} maxLength={4} className="w-20 px-2 py-2 border border-[var(--border)] rounded text-center focus:ring-2 focus:ring-purple-500 outline-none bg-[var(--input-bg)] text-[var(--text-primary)]" placeholder="Urut" />
                      <input type="text" required value={nopAsalJenis} onChange={e => { setNopAsalJenis(e.target.value); setNopJenis(e.target.value); }} maxLength={1} className="w-12 px-2 py-2 border border-[var(--border)] rounded text-center focus:ring-2 focus:ring-purple-500 outline-none bg-[var(--input-bg)] text-[var(--text-primary)]" placeholder="Jns" />
                    </div>
                  </div>
                )}
              </>
                ...
                {alasanPenghapusan === "Double NOP" && (
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-center">
                    ...
                    <div className="md:col-span-3 flex flex-wrap items-center gap-2">
                      ...
                      <input type="text" value={nopDoubleKec} onChange={e => setNopDoubleKec(e.target.value)} maxLength={3} className={`w-14 px-2 py-2 border border-[var(--border)] rounded text-center focus:ring-2 focus:ring-purple-500 outline-none ${isNopLocked ? "bg-[var(--section-bg)] text-[var(--text-secondary)]" : "bg-[var(--input-bg)] text-[var(--text-primary)]"}`} readOnly={isNopLocked} placeholder="Kec" />
                      <input type="text" value={nopDoubleKel} onChange={e => setNopDoubleKel(e.target.value)} maxLength={3} className={`w-14 px-2 py-2 border border-[var(--border)] rounded text-center focus:ring-2 focus:ring-purple-500 outline-none ${isNopLocked ? "bg-[var(--section-bg)] text-[var(--text-secondary)]" : "bg-[var(--input-bg)] text-[var(--text-primary)]"}`} readOnly={isNopLocked} placeholder="Kel" />
                      <input type="text" required value={nopDoubleBlok} onChange={e => setNopDoubleBlok(e.target.value)} maxLength={3} className="w-16 px-2 py-2 border border-[var(--border)] rounded text-center focus:ring-2 focus:ring-purple-500 outline-none bg-[var(--input-bg)] text-[var(--text-primary)]" placeholder="Blok" />
                      <input type="text" required value={nopDoubleUrut} onChange={e => setNopDoubleUrut(e.target.value)} maxLength={4} className="w-20 px-2 py-2 border border-[var(--border)] rounded text-center focus:ring-2 focus:ring-purple-500 outline-none bg-[var(--input-bg)] text-[var(--text-primary)]" placeholder="Urut" />
                      <input type="text" required value={nopDoubleJenis} onChange={e => setNopDoubleJenis(e.target.value)} maxLength={1} className="w-12 px-2 py-2 border border-[var(--border)] rounded text-center focus:ring-2 focus:ring-purple-500 outline-none bg-[var(--input-bg)] text-[var(--text-primary)]" placeholder="Jns" />
                    </div>
                  </div>
                )}
              </>
          ...
          <div className="p-6 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
              <div className="flex flex-col">
                ...
                <input type="text" required value={noKtp} onChange={e=>setNoKtp(e.target.value.replace(/\D/g, '').substring(0, 16))} maxLength={16} minLength={16} className="w-full px-4 py-2 border border-[var(--border)] rounded focus:ring-2 focus:ring-purple-500 outline-none" />
              </div>
              <div className="flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
              ...
              <div className="flex flex-col">
                ...
                <input type="text" value={npwp} onChange={e=>setNpwp(e.target.value.replace(/\D/g, ''))} className="w-full px-4 py-2 border border-[var(--border)] rounded focus:ring-2 focus:ring-purple-500 outline-none" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
              ...
              <div className="flex flex-col">
                ...
                <input type="text" value={noHp} onChange={e=>setNoHp(e.target.value.replace(/\D/g, ''))} className="w-full px-4 py-2 border border-[var(--border)] rounded focus:ring-2 focus:ring-purple-500 outline-none" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center space-x-2">
                  <input type="text" required maxLength={2} value={rtRwWp.split('/')[0] || ""} onChange={e=>setRtRwWp(`${e.target.value.replace(/\D/g, '').substring(0,2)}/${rtRwWp.split('/')[1]||""}`)} className="w-16 px-4 py-2 border border-[var(--border)] rounded focus:ring-2 focus:ring-purple-500 outline-none text-center" />
                  <span>/</span>
                  <input type="text" required maxLength={2} value={rtRwWp.split('/')[1] || ""} onChange={e=>setRtRwWp(`${rtRwWp.split('/')[0]||""}/${e.target.value.replace(/\D/g, '').substring(0,2)}`)} className="w-16 px-4 py-2 border border-[var(--border)] rounded focus:ring-2 focus:ring-purple-500 outline-none text-center" />
                </div>
              </div>
            </div>
          ...
          <div className="p-6 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-center">
              ...
              <div className="md:col-span-3 flex items-center space-x-2">
                <input type="text" required maxLength={2} value={rtRwOp.split('/')[0] || ""} onChange={e=>setRtRwOp(`${e.target.value.replace(/\D/g, '').substring(0,2)}/${rtRwOp.split('/')[1]||""}`)} className="w-16 px-4 py-2 border border-[var(--border)] rounded focus:ring-2 focus:ring-purple-500 outline-none text-center" />
                <span>/</span>
                <input type="text" required maxLength={2} value={rtRwOp.split('/')[1] || ""} onChange={e=>setRtRwOp(`${rtRwOp.split('/')[0]||""}/${e.target.value.replace(/\D/g, '').substring(0,2)}`)} className="w-16 px-4 py-2 border border-[var(--border)] rounded focus:ring-2 focus:ring-purple-500 outline-none text-center bg-[var(--input-bg)] text-[var(--text-primary)]" />
              </div>
            </div>
